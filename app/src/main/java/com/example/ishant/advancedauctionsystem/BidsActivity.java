...
public class BidsActivity extends OrmActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.auction_bids);
		setupToolbar();
	...
	private class BidsAdapter extends BaseAdapter {
		...
		public BidsAdapter() {
			inflater = LayoutInflater.from(BidsActivity.this);
		}
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			if (convertView == null) {
				convertView = inflater.inflate(R.layout.bids_item_list, null);
