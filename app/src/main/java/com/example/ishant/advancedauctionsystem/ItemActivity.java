...
import com.example.ishant.advancedauctionsystem.fragment.SubmitBidFragment;
...
public class ItemActivity extends OrmActivity implements OnClickListener, SubmitBidFragment.SubmitBidCallbacks {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.auction_item);
		setupToolbar();
		...
		if (auctionItem == null) {
			...
			Collection<ItemPic> itemPhotos = auctionItem.getItemPhotos();
			if (itemPhotos != null) {
